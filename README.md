...
1. > amplify env add - would be like "prod", "dev", "test"
2. > amplify push - would run after adding each env
3. > amplify env checkout <name> - use to switch between environments
4. > amplify env list - displays a list of all environments
